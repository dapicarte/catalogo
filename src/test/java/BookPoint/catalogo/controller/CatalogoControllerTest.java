...
public class CatalogoControllerTest {
    ...
    void testListarCatalogo() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/catalogo"))
            ...
            .andExpect(jsonPath("$[0].nombreCatalogo", is("Verano 2026")))
            .andExpect(jsonPath("$[1].nombreCatalogo", is("Invierno 2026")));
    }

    @Test
    void testListarCatalogoVacio() throws Exception {
    ...
    @Test
    void testCrearCatalogoError() throws Exception {
        Catalogo nuevo = new Catalogo(null, "Verano 2026", null, null);
    ...
    @Test
    void testActualizarCatalogoNoExistente() throws Exception {
        Catalogo datosNuevos = new Catalogo(null, "Verano Actualizado", null, null);
